...
#ifndef SIMPLE_GROUP_LABEL_FINDER_H
#define SIMPLE_GROUP_LABEL_FINDER_H
...
class SimpleGroupLabelFinder : public DiscreteGroupLabelFinder {
  public :
	SimpleGroupLabelFinder(const SignatureDatabase *sd,
	...
	clearCompensateCount();
	minor = NULL;
  };

  ~SimpleGroupLabelFinder();
  ...
  long getCompensateCount() { 
	return compensateCounter + pLabeler->getCompensateCount(); 
  }

  void clearCompensateCount() { 
	compensateCounter = 0; 
	pLabeler->clearCompensateCount();
  }
