...
#ifndef BRUTAL_FORCE_GROUP_LABEL_FINDER_H
#define BRUTAL_FORCE_GROUP_LABEL_FINDER_H
...
class BFGroupLabelFinder : public DiscreteGroupLabelFinder {
  public :
	BFGroupLabelFinder(const SignatureDatabase *sd,
