...
#ifndef QUANTITY_LABEL_WRITER_H
#define QUANTITY_LABEL_WRITER_H

#include <DiscreteLabel.h>
#include <DiscreteLabelWriter.h>
#include <SignatureDatabase.h>

class QuantityLabelWriter {
  public :
	QuantityLabelWriter(const char *filename, 
			    int nSigs,
  ...
  void writeLabel(int id, double * lbl);
  
  void writeLabel(int id, double *lbl, SignatureDatabase *psd);
