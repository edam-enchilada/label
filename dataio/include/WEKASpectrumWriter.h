...
#ifndef WEKASPECTRUM_WRITER_H
#define WEKASPECTRUM_WRITER_H

#include <Spectrum.h>
#include <SpectrumReader.h>

class WEKASpectrumWriter {
  public :
	WEKASpectrumWriter(const char *filename, SpcFileType filemode);

  ~WEKASpectrumWriter();

  void writeSpectrum(Spectrum *sp);
