...
void SpectrumWriter::writeString(char *buf) {
	fprintf(file, "%s", buf);
}

SpectrumWriter::SpectrumWriter(const char *filename, SpcFileType mode) {
  file = NULL;
  fn = NULL;
...
void SpectrumWriter::writeSpectrum(Spectrum *sp) {
